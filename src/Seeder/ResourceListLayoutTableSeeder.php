...
class ResourceListLayoutTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceListLayout::query()
            ...
            ->create([	'id' => '2126172', 	'resource_list' => '2123121', 	'label' => 'Services', 	'field' => 'name', 	'relation' => '2109188', 											])
            ...
            ->create([	'id' => '2126175', 	'resource_list' => '2123121', 	'label' => 'Delivery Date', 	'field' => 'delivery', 												])
            ->create([	'id' => '2126176', 	'resource_list' => '2123121', 	'label' => 'Progress', 	'field' => 'progress', 												])
            ->create([	'id' => '2126177', 	'resource_list' => '2123122', 	'label' => 'Order Item', 	'field' => 'name', 	'relation' => '2109158', 											])
            ->create([	'id' => '2126178', 	'resource_list' => '2123122', 	'label' => 'Service', 	'field' => 'name', 	'relation' => '2109159', 											])
            ->create([	'id' => '2126179', 	'resource_list' => '2123122', 	'label' => 'Providers', 	'field' => 'name', 	'relation' => '2109189', 											])
            ->create([	'id' => '2126180', 	'resource_list' => '2123122', 	'label' => 'Progress', 	'field' => 'progress', 												])
            ->create([	'id' => '2126181', 	'resource_list' => '2123123', 	'label' => 'OI Service', 	'field' => 'name', 	'relation' => '2109168', 											])
            ->create([	'id' => '2126182', 	'resource_list' => '2123123', 	'label' => 'Provider', 	'field' => 'name', 	'relation' => '2109169', 											])
            ->create([	'id' => '2126183', 	'resource_list' => '2123123', 	'label' => 'Assigned', 	'field' => 'assigned', 												])
            ->create([	'id' => '2126184', 	'resource_list' => '2123123', 	'label' => 'Service Start At', 	'field' => 'start_at', 												])
            ->create([	'id' => '2126185', 	'resource_list' => '2123123', 	'label' => 'Service End At', 	'field' => 'end_at', 												])
            ->create([	'id' => '2126186', 	'resource_list' => '2123123', 	'label' => 'Serviced Time', 	'field' => 'service_time', 												])
            ->create([	'id' => '2126187', 	'resource_list' => '2123123', 	'label' => 'Total Time', 	'field' => 'total_time', 												])
            ->create([	'id' => '2126188', 	'resource_list' => '2123125', 	'label' => 'ID', 	'field' => 'id', 												])
            ->create([	'id' => '2126189', 	'resource_list' => '2123125', 	'label' => 'Customer', 	'field' => 'name', 	'relation' => '2109147', 											])
            ->create([	'id' => '2126190', 	'resource_list' => '2123125', 	'label' => 'Date', 	'field' => 'date', 												])
            ->create([	'id' => '2126191', 	'resource_list' => '2123125', 	'label' => 'Progress', 	'field' => 'progress', 												])
        ;
