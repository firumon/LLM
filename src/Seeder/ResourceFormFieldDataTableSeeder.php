...
class ResourceFormFieldDataTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldData::query()
            ...
            ->create([	'id' => '2112146', 	'form_field' => '2111146', 	'attribute' => 'hub', 													])
            ->create([	'id' => '2112147', 	'form_field' => '2111147', 	'attribute' => 'code', 													])
            ->create([	'id' => '2112148', 	'form_field' => '2111148', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112149', 	'form_field' => '2111149', 	'attribute' => 'customer', 													])
            ->create([	'id' => '2112150', 	'form_field' => '2111150', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112151', 	'form_field' => '2111151', 	'attribute' => 'pl', 													])
            ->create([	'id' => '2112152', 	'form_field' => '2111152', 	'attribute' => 'order', 													])
            ->create([	'id' => '2112153', 	'form_field' => '2111153', 	'attribute' => 'item', 													])
            ->create([	'id' => '2112154', 	'form_field' => '2111154', 	'attribute' => 'service', 	'relation' => '2109188', 												])
            ->create([	'id' => '2112155', 	'form_field' => '2111155', 	'attribute' => 'label', 													])
            ->create([	'id' => '2112156', 	'form_field' => '2111156', 	'attribute' => 'item', 													])
            ->create([	'id' => '2112157', 	'form_field' => '2111157', 	'attribute' => 'service', 	'relation' => '2109188', 												])
            ->create([	'id' => '2112158', 	'form_field' => '2111158', 	'attribute' => 'label', 													])
            ->create([	'id' => '2112159', 	'form_field' => '2111159', 	'attribute' => 'shelf', 													])
            ->create([	'id' => '2112160', 	'form_field' => '2111160', 	'attribute' => 'delivery', 													])
            ->create([	'id' => '2112161', 	'form_field' => '2111161', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112162', 	'form_field' => '2111162', 	'attribute' => 'ois', 													])
            ->create([	'id' => '2112163', 	'form_field' => '2111163', 	'attribute' => 'user', 													])
            ->create([	'id' => '2112164', 	'form_field' => '2111164', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112165', 	'form_field' => '2111165', 	'attribute' => 'invoice', 													])
            ->create([	'id' => '2112166', 	'form_field' => '2111166', 	'attribute' => 'amount', 													])
            ->create([	'id' => '2112167', 	'form_field' => '2111167', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112168', 	'form_field' => '2111168', 	'attribute' => 'order', 													])
            ->create([	'id' => '2112169', 	'form_field' => '2111169', 	'attribute' => 'oi', 	'relation' => '2109173', 												])
            ->create([	'id' => '2112170', 	'form_field' => '2111170', 	'attribute' => 'source_hub', 													])
            ->create([	'id' => '2112171', 	'form_field' => '2111171', 	'attribute' => 'destination_hub', 													])
            ->create([	'id' => '2112172', 	'form_field' => '2111172', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112173', 	'form_field' => '2111173', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112174', 	'form_field' => '2111174', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112175', 	'form_field' => '2111175', 	'attribute' => 'email', 													])
            ->create([	'id' => '2112176', 	'form_field' => '2111176', 	'attribute' => 'password', 													])
            ->create([	'id' => '2112177', 	'form_field' => '2111177', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112178', 	'form_field' => '2111178', 	'attribute' => 'description', 													])
            ->create([	'id' => '2112179', 	'form_field' => '2111179', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112180', 	'form_field' => '2111180', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112181', 	'form_field' => '2111181', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112182', 	'form_field' => '2111182', 	'attribute' => 'description', 													])
        ;
