...
class ResourceFormFieldDataTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldData::query()
            ...
            ->create([	'id' => '2112155', 	'form_field' => '2111155', 	'attribute' => 'quantity', 													])
            ->create([	'id' => '2112156', 	'form_field' => '2111156', 	'attribute' => 'label', 													])
            ->create([	'id' => '2112157', 	'form_field' => '2111157', 	'attribute' => 'hub', 													])
            ...
            ->create([	'id' => '2112161', 	'form_field' => '2111161', 	'attribute' => 'quantity', 													])
            ->create([	'id' => '2112162', 	'form_field' => '2111162', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112163', 	'form_field' => '2111163', 	'attribute' => 'ois', 													])
            ->create([	'id' => '2112164', 	'form_field' => '2111164', 	'attribute' => 'user', 													])
            ->create([	'id' => '2112165', 	'form_field' => '2111165', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112166', 	'form_field' => '2111166', 	'attribute' => 'invoice', 													])
            ->create([	'id' => '2112167', 	'form_field' => '2111167', 	'attribute' => 'amount', 													])
            ->create([	'id' => '2112168', 	'form_field' => '2111168', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112169', 	'form_field' => '2111169', 	'attribute' => 'order', 													])
            ->create([	'id' => '2112170', 	'form_field' => '2111171', 	'attribute' => 'source_hub', 													])
            ->create([	'id' => '2112171', 	'form_field' => '2111172', 	'attribute' => 'destination_hub', 													])
            ->create([	'id' => '2112172', 	'form_field' => '2111173', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112173', 	'form_field' => '2111174', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112174', 	'form_field' => '2111175', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112175', 	'form_field' => '2111176', 	'attribute' => 'email', 													])
            ->create([	'id' => '2112176', 	'form_field' => '2111177', 	'attribute' => 'password', 													])
            ->create([	'id' => '2112177', 	'form_field' => '2111178', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112178', 	'form_field' => '2111179', 	'attribute' => 'description', 													])
            ->create([	'id' => '2112179', 	'form_field' => '2111180', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112180', 	'form_field' => '2111181', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112181', 	'form_field' => '2111182', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112182', 	'form_field' => '2111183', 	'attribute' => 'description', 													])
            ->create([	'id' => '2112183', 	'form_field' => '2111184', 	'attribute' => 'customer', 													])
            ->create([	'id' => '2112184', 	'form_field' => '2111185', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112185', 	'form_field' => '2111186', 	'attribute' => 'pl', 													])
            ->create([	'id' => '2112186', 	'form_field' => '2111187', 	'attribute' => 'hub', 													])
            ->create([	'id' => '2112187', 	'form_field' => '2111188', 	'attribute' => 'start_at', 													])
            ->create([	'id' => '2112188', 	'form_field' => '2111189', 	'attribute' => 'end_at', 													])
        ;
