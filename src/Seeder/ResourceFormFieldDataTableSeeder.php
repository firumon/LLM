...
class ResourceFormFieldDataTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldData::query()
            ...
            ->create([	'id' => '2112156', 	'form_field' => '2111156', 	'attribute' => 'hub', 													])
            ...
            ->create([	'id' => '2112160', 	'form_field' => '2111160', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112161', 	'form_field' => '2111161', 	'attribute' => 'ois', 													])
            ->create([	'id' => '2112162', 	'form_field' => '2111162', 	'attribute' => 'user', 													])
            ->create([	'id' => '2112163', 	'form_field' => '2111163', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112164', 	'form_field' => '2111164', 	'attribute' => 'invoice', 													])
            ->create([	'id' => '2112165', 	'form_field' => '2111165', 	'attribute' => 'amount', 													])
            ->create([	'id' => '2112166', 	'form_field' => '2111166', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112167', 	'form_field' => '2111167', 	'attribute' => 'order', 													])
            ->create([	'id' => '2112168', 	'form_field' => '2111168', 	'attribute' => 'oi', 	'relation' => '2109173', 												])
            ->create([	'id' => '2112169', 	'form_field' => '2111169', 	'attribute' => 'source_hub', 													])
            ->create([	'id' => '2112170', 	'form_field' => '2111170', 	'attribute' => 'destination_hub', 													])
            ->create([	'id' => '2112171', 	'form_field' => '2111171', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112172', 	'form_field' => '2111172', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112173', 	'form_field' => '2111173', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112174', 	'form_field' => '2111174', 	'attribute' => 'email', 													])
            ->create([	'id' => '2112175', 	'form_field' => '2111175', 	'attribute' => 'password', 													])
            ->create([	'id' => '2112176', 	'form_field' => '2111176', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112177', 	'form_field' => '2111177', 	'attribute' => 'description', 													])
            ->create([	'id' => '2112178', 	'form_field' => '2111178', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112179', 	'form_field' => '2111179', 	'attribute' => 'name', 													])
            ->create([	'id' => '2112180', 	'form_field' => '2111180', 	'attribute' => 'status', 													])
            ->create([	'id' => '2112181', 	'form_field' => '2111181', 	'attribute' => 'description', 													])
            ->create([	'id' => '2112182', 	'form_field' => '2111182', 	'attribute' => 'customer', 													])
            ->create([	'id' => '2112183', 	'form_field' => '2111183', 	'attribute' => 'date', 													])
            ->create([	'id' => '2112184', 	'form_field' => '2111184', 	'attribute' => 'pl', 													])
            ->create([	'id' => '2112185', 	'form_field' => '2111185', 	'attribute' => 'hub', 													])
            ->create([	'id' => '2112186', 	'form_field' => '2111186', 	'attribute' => 'start_at', 													])
            ->create([	'id' => '2112187', 	'form_field' => '2111187', 	'attribute' => 'end_at', 													])
        ;
