...
class ResourceRelationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceRelation::query()
            ...
            ->create([	'id' => '2109190', 	'resource' => '2106123', 	'name' => 'AssignedBy', 	'description' => 'The user who assigned this service to a provider', 	'method' => 'Assigned', 	'type' => 'belongsTo', 	'relate_resource' => '2106102', 									])
        ;
