...
class ResourceRelationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceRelation::query()
            ...
            ->create([	'id' => '2109124', 	'resource' => '2106109', 	'name' => 'ItemServices', 	'description' => 'Services available for the item', 	'method' => 'ItemServices', 	'type' => 'hasMany', 	'relate_resource' => '2106110', 									])
            ...
            ->create([	'id' => '2109147', 	'resource' => '2106118', 	'name' => 'CustomerDetail', 	'description' => 'Customer detail', 	'method' => 'Customer', 	'type' => 'belongsTo', 	'relate_resource' => '2106105', 									])
            ...
            ->create([	'id' => '2109156', 	'resource' => '2106119', 	'name' => 'OrderItemServices', 	'description' => 'List of services to be applied', 	'method' => 'OIS', 	'type' => 'hasMany', 	'relate_resource' => '2106120', 									])
            ...
            ->create([	'id' => '2109160', 	'resource' => '2106120', 	'name' => 'AssignedUsers', 	'description' => 'The list of users assigned to provide service', 	'method' => 'Assigned', 	'type' => 'hasMany', 	'relate_resource' => '2106123', 									])
            ...
            ->create([	'id' => '2109168', 	'resource' => '2106123', 	'name' => 'OIS', 	'description' => 'Detail of order item service', 	'method' => 'OIS', 	'type' => 'belongsTo', 	'relate_resource' => '2106120', 									])
            ...
            ->create([	'id' => '2109188', 	'resource' => '2106119', 	'name' => 'ItemServices', 	'description' => 'List of services to be applied', 	'method' => 'Services', 	'type' => 'belongsToMany', 	'relate_resource' => '2106108', 									])
