...
class ResourceTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\Resource::query()
            ...
            ->create([	'id' => '2106125', 	'name' => 'Delivery', 	'description' => 'The order items to be delivered', 	'title' => 'Delivery', 	'namespace' => 'Firumon\LLM\Model', 	'table' => 'delivery', 	'controller' => 'DeliveryController', 	'controller_namespace' => 'Firumon\LLM\Controller', 								])
