...
class ResourceTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\Resource::query()
            ...
            ->create([	'id' => '2106118', 	'name' => 'Order', 	'description' => 'Orders are the set of items that are submitted by a customer for servicing', 	'title' => 'Orders', 	'namespace' => 'Firumon\LLM\Model', 	'table' => 'orders', 										])
            ...
            ->create([	'id' => '2106123', 	'name' => 'OrderItemServiceUser', 	'description' => 'The user who responsible to perform a service on a order item', 	'title' => 'Service Provider', 	'namespace' => 'Firumon\LLM\Model', 	'table' => 'order_item_service_user', 										])
            ->create([	'id' => '2106124', 	'name' => 'Receipt', 	'description' => 'Recepits when a customer made payments against a invoice', 	'title' => 'Receipts', 	'namespace' => 'Firumon\LLM\Model', 	'table' => 'receipts', 										])
