...
class ResourceFormFieldOptionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldOption::query()
            ...
            ->create([	'id' => '2113107', 	'form_field' => '2111133', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'name', 										])
            ->create([	'id' => '2113108', 	'form_field' => '2111135', 	'type' => 'Enum', 													])
            ->create([	'id' => '2113109', 	'form_field' => '2111136', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'name', 										])
            ->create([	'id' => '2113110', 	'form_field' => '2111137', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'name', 										])
            ->create([	'id' => '2113111', 	'form_field' => '2111140', 	'type' => 'Enum', 													])
            ->create([	'id' => '2113112', 	'form_field' => '2111141', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'name', 										])
            ...
            ->create([	'id' => '2113127', 	'form_field' => '2111163', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'date', 										])
            ->create([	'id' => '2113128', 	'form_field' => '2111166', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'date', 										])
            ->create([	'id' => '2113129', 	'form_field' => '2111167', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'id', 										])
