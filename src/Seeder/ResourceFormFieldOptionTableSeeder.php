...
class ResourceFormFieldOptionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldOption::query()
            ...
            ->create([	'id' => '2113131', 	'form_field' => '2111167', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'date', 										])
            ->create([	'id' => '2113132', 	'form_field' => '2111168', 	'type' => 'Foreign', 		'value_attr' => 'id', 	'label_attr' => 'id', 										])
