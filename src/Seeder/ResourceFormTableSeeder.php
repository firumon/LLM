...
class ResourceFormTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceForm::query()
            ...
            ->create([	'id' => '2110128', 	'resource' => '2106123', 	'name' => 'JobStartForm', 		'title' => 'Start Job', 	'action_text' => 'Start', 										])
            ->create([	'id' => '2110129', 	'resource' => '2106123', 	'name' => 'FinishJobForm', 		'title' => 'Finish Job', 	'action_text' => 'Done', 										])
        ;
