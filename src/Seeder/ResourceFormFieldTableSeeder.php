...
class ResourceFormFieldTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormField::query()
            ...
            ->create([	'id' => '2111155', 	'resource_form' => '2110117', 	'name' => 'label', 	'type' => 'select', 	'label' => 'Label', 											])
            ->create([	'id' => '2111156', 	'resource_form' => '2110118', 	'name' => 'item', 	'type' => 'select', 	'label' => 'Select Item', 											])
            ->create([	'id' => '2111157', 	'resource_form' => '2110118', 	'name' => 'service', 	'type' => 'multiselect', 	'label' => 'Select Service', 											])
            ...
            ->create([	'id' => '2111161', 	'resource_form' => '2110118', 	'name' => 'status', 	'type' => 'select', 	'label' => 'Status', 											])
            ->create([	'id' => '2111162', 	'resource_form' => '2110119', 	'name' => 'ois', 	'type' => 'select', 	'label' => 'Order Item Service', 											])
            ->create([	'id' => '2111163', 	'resource_form' => '2110119', 	'name' => 'user', 	'type' => 'select', 	'label' => 'Select Provider', 											])
            ->create([	'id' => '2111164', 	'resource_form' => '2110120', 	'name' => 'date', 	'type' => 'text', 	'label' => 'Enter date (yyyy-mm-dd)', 											])
            ->create([	'id' => '2111165', 	'resource_form' => '2110120', 	'name' => 'invoice', 	'type' => 'select', 	'label' => 'Select Invoice to be paid', 											])
            ->create([	'id' => '2111166', 	'resource_form' => '2110120', 	'name' => 'amount', 	'type' => 'text', 	'label' => 'Amount', 											])
            ->create([	'id' => '2111167', 	'resource_form' => '2110121', 	'name' => 'date', 	'type' => 'text', 	'label' => 'Enter date (yyyy-mm-dd)', 											])
            ->create([	'id' => '2111168', 	'resource_form' => '2110121', 	'name' => 'order', 	'type' => 'select', 	'label' => 'Select Order', 											])
            ->create([	'id' => '2111169', 	'resource_form' => '2110121', 	'name' => 'oi', 	'type' => 'multiselect', 	'label' => 'Select Order Item', 											])
            ->create([	'id' => '2111170', 	'resource_form' => '2110123', 	'name' => 'source_hub', 	'type' => 'select', 	'label' => 'Select From Hub', 											])
            ->create([	'id' => '2111171', 	'resource_form' => '2110123', 	'name' => 'destination_hub', 	'type' => 'select', 	'label' => 'Select To Hub', 											])
            ->create([	'id' => '2111172', 	'resource_form' => '2110123', 	'name' => 'date', 	'type' => 'text', 	'label' => 'Date', 											])
            ->create([	'id' => '2111173', 	'resource_form' => '2110123', 	'name' => 'status', 	'type' => 'select', 	'label' => 'Status', 											])
            ->create([	'id' => '2111174', 	'resource_form' => '2110124', 	'name' => 'name', 	'type' => 'text', 	'label' => 'Name', 											])
            ->create([	'id' => '2111175', 	'resource_form' => '2110124', 	'name' => 'email', 	'type' => 'text', 	'label' => 'Email', 											])
            ->create([	'id' => '2111176', 	'resource_form' => '2110124', 	'name' => 'password', 	'type' => 'password', 	'label' => 'Password', 											])
            ->create([	'id' => '2111177', 	'resource_form' => '2110125', 	'name' => 'name', 	'type' => 'text', 	'label' => 'Name', 											])
            ->create([	'id' => '2111178', 	'resource_form' => '2110125', 	'name' => 'description', 	'type' => 'textarea', 	'label' => 'Description', 											])
            ->create([	'id' => '2111179', 	'resource_form' => '2110125', 	'name' => 'status', 	'type' => 'select', 	'label' => 'Status', 											])
            ->create([	'id' => '2111180', 	'resource_form' => '2110126', 	'name' => 'name', 	'type' => 'text', 	'label' => 'Name', 											])
            ->create([	'id' => '2111181', 	'resource_form' => '2110126', 	'name' => 'status', 	'type' => 'select', 	'label' => 'Status', 											])
            ->create([	'id' => '2111182', 	'resource_form' => '2110126', 	'name' => 'description', 	'type' => 'textarea', 	'label' => 'Description', 											])
        ;
